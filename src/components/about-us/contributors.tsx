  ...
  <section className="about-us-contributors">
    <Row typeof="flex" justify="space-between" align="middle">
      <Col span={24}>
        ...
        <br />
        <p>Podes consultar <a target="_blank" rel="noopener noreferrer" href="https://www.loomio.org/g/ZqT2uPv6/politica-para-todos">aqui</a> todo o histórico do projecto.</p>
        <p className="about-us-contributors-list">{shuffleList(contributors).join(", ")}.</p>
      </Col>
    </Row>
  </section >
);
